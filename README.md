...
### 中文
2026-05-31 飞书会议归档：把会议纪要整理成静态复盘页，便于浏览、复盘和索引。
...
- GitHub 仓库 / Repository: https://github.com/siuserxiaowei/2026-05-31-feishu-minutes-obcnxiqa
- Live / 在线入口：https://siuserxiaowei.github.io/2026-05-31-feishu-minutes-obcnxiqa/
...
```bash
git clone https://github.com/siuserxiaowei/2026-05-31-feishu-minutes-obcnxiqa.git
cd 2026-05-31-feishu-minutes-obcnxiqa
...
- 妙记：https://vi8r050ecuz.feishu.cn/minutes/obcnxiqab9q73726nd8p6bvb
- 模板：one_page
- 页面：`docs/index.html`
